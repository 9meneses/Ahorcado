...
public class VentanaAhorcado extends javax.swing.JFrame {
    ...
    private void chequeaLetra(String letra){
        letra = letra.toUpperCase(); //pasamos las letras a mayúsculas
    ...
    private void dibujaImagen (int numeroImagen){
        ...
        //escala la imagen al ancho y alto del jlabel
    ...
    private void initComponents() {
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(264, 264));
        jLabel2.setMinimumSize(new java.awt.Dimension(264, 264));
        jLabel2.setPreferredSize(new java.awt.Dimension(264, 264));
